...
Проверенные архивы также каждый час забирает отдельный физический сервер по
модели pull. На нём хранится 90 дней ежечасных копий, а ключ production-сервера
не имеет доступа к внешнему хранилищу. Настройка, проверка и восстановление
описаны в [документации внешних резервных копий](docs/offsite-backups.md).
