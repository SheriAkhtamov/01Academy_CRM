...
export const translations = {
  ...
  globalSearchPlaceholder: { en: 'Global search: lead, student, phone, Telegram, group, course', ru: 'Глобальный поиск: лид, ученик, телефон, Telegram, группа, курс' },
  ...
  noTeacher: { en: 'no teacher', ru: 'нет преподавателя' },
  ...
  projectsLabel: { en: 'Projects:', ru: 'Проекты:' },
  ...
  studentsAndCards: { en: 'Students and Learning Cards', ru: 'Ученики и карточки обучения' },
