...
export const translations = {
  ...
  myLeadsAndStudents: { en: 'From my leads and students', ru: 'По моим лидам и ученикам' },
  ...
  revenueMonth: { en: 'Revenue This Month', ru: 'Выручка за месяц' },
  ...
  adminDataCoursesDesc: { en: 'Maintain course programs, prices, and active status.', ru: 'Управление программами курсов, ценами и активностью.' },
  adminDataDescription: { en: 'Correct and maintain records created by the role-based workspaces.', ru: 'Исправление и обслуживание данных, созданных в рабочих областях сотрудников.' },
  adminDataFinanceDesc: { en: 'Review financial summaries and correct finance records.', ru: 'Проверка финансовых сводок и корректировка финансовых данных.' },
  adminDataGroupsDesc: { en: 'Maintain groups, capacity, teachers, and schedules.', ru: 'Управление группами, вместимостью, преподавателями и расписанием.' },
  adminDataIntegrationsDesc: { en: 'Configure connected services and channel tests.', ru: 'Настройка подключённых сервисов и проверка каналов.' },
  adminDataLeadsDesc: { en: 'Correct lead cards, sources, managers, and statuses.', ru: 'Корректировка карточек лидов, источников, менеджеров и статусов.' },
  adminDataLessonsDesc: { en: 'Maintain lessons, attendance links, and lesson statuses.', ru: 'Управление занятиями, посещаемостью и статусами уроков.' },
  adminDataPaymentsDesc: { en: 'Check payments, discounts, statuses, and confirmations.', ru: 'Проверка оплат, скидок, статусов и подтверждений.' },
  adminDataPipelineDesc: { en: 'Audit pipeline movement and fix stuck deals.', ru: 'Аудит движения по воронке и исправление зависших сделок.' },
  adminDataStudentsDesc: { en: 'Correct student profiles, groups, risks, and progress.', ru: 'Корректировка учеников, групп, рисков и прогресса.' },
  adminDataTeachersDesc: { en: 'Maintain teacher profiles, assignments, and statuses.', ru: 'Управление преподавателями, назначениями и статусами.' },
  adminWorkspaceSubtitle: { en: 'Manage employees, access, system records, and CRM configuration.', ru: 'Управление сотрудниками, доступами, системными данными и настройками CRM.' },
  ...
  dataMaintenance: { en: 'Data Maintenance', ru: 'Обслуживание данных' },
  dataTab: { en: 'Data', ru: 'Данные' },
  ...
  openSection: { en: 'Open section', ru: 'Открыть раздел' },
  operationalData: { en: 'CRM Data Maintenance', ru: 'Обслуживание данных CRM' },
  ...
  usersTab: { en: 'Employees', ru: 'Сотрудники' },
