...
export const translations = {
  ...
  leadMergeStudentConflict: {
    en: 'Both leads already have student records. Resolve the student cards before merging these leads.',
    ru: 'У обоих лидов уже есть карточки учеников. Сначала разберите карточки учеников, затем объедините лидов.',
  },
  leadMergeStudentConflictTitle: { en: 'Student records need attention', ru: 'Нужно проверить карточки учеников' },
  ...
  groupAddFailed: { en: 'Could not add the group', ru: 'Не удалось добавить группу' },
  groupRemoveFailed: { en: 'Could not remove the group', ru: 'Не удалось убрать группу' },
