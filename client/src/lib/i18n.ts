...
export const translations = {
  ...
  leadGroups: { en: 'Selected lead groups', ru: 'Выбранные группы лида' },
  studentGroups: { en: 'Student groups', ru: 'Группы ученика' },
  noGroupsSelected: { en: 'No groups selected yet', ru: 'Группы пока не выбраны' },
  ...
  leadGroupAdded: { en: 'Group added to the lead', ru: 'Группа добавлена лиду' },
  leadGroupRemoved: { en: 'Group removed from the lead', ru: 'Группа убрана у лида' },
