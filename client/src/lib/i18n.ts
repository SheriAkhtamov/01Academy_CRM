...
export const translations = {
  ...
  shiftFollowingLessons: { en: 'Move following lessons too', ru: 'Сдвинуть и следующие занятия' },
  shiftFollowingLessonsHint: { en: 'The order and intervals between lessons will be preserved.', ru: 'Порядок и интервалы между занятиями сохранятся.' },
  ...
  onlyScheduledLessonCanBeRescheduled: { en: 'Only a scheduled lesson can be rescheduled', ru: 'Переносить можно только запланированное занятие' },
  ...
  rescheduleChainMustPreserveSchedule: { en: 'Moving the remaining lesson sequence must preserve its weekly days and times', ru: 'При сдвиге цепочки нужно сохранить недельные дни и время расписания' },
