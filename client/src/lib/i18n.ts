...
export const translations = {
  ...
  studentGroupAddFailed: { en: 'Could not enroll the student in the group', ru: 'Не удалось зачислить ученика в группу' },
  studentGroupRemoveFailed: { en: 'Could not remove the student from the group', ru: 'Не удалось убрать ученика из группы' },
