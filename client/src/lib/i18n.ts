...
export const translations = {
  ...
  groupSchoolScheduleConflict: { en: 'Another group or lesson already uses this school on one of the selected days and times.', ru: 'В этой школе уже есть другая группа или занятие в один из выбранных дней и часов.' },
