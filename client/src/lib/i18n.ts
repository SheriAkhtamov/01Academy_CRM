...
export const translations = {
  ...
  onlinePbxCallStarted: { en: 'Call started', ru: 'Звонок запущен' },
  onlinePbxCallStartedDescription: {
    en: 'OnlinePBX will call you first and connect the customer after you answer.',
    ru: 'Сначала OnlinePBX позвонит вам, а после ответа соединит с клиентом.',
  },
  ...
  onlinePbxExtensionHint: {
    en: 'Optional. If empty, OnlinePBX will call the employee phone specified above.',
    ru: 'Необязательно. Если оставить пустым, OnlinePBX позвонит на телефон сотрудника, указанный выше.',
  },
