...
export const translations = {
  ...
  salesModuleLeadsTransferDescription: { en: 'This employee has {count} assigned lead(s). Before removing the Sales module, transfer them to another sales manager.', ru: 'У сотрудника {count} назначенных лидов. Перед отключением модуля продаж передайте их другому менеджеру.' },
  ...
  disableSalesAndTransfer: { en: 'Disable Sales module and transfer', ru: 'Отключить продажи и передать лиды' },
