    ...
    <div className="min-h-[60vh] w-full flex items-center justify-center">
      <Card className="w-full max-w-md mx-4 hover-lift">
        <CardContent className="pt-8 pb-8 text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold text-foreground tracking-tight">{t('pageNotFound')}</h1>
          <p className="mt-2 text-sm text-muted-foreground">{t('pageNotFoundDescription')}</p>
          <Link href="/">
