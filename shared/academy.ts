...
export const LEAD_STATUSES = [
  ...
  { code: "ne_prishli_na_vstrechu", name: "Не пришли на встречу", translationKey: "leadStatusDemoNoShow", color: "#ef4444", sortOrder: 45, activePipeline: true },
  { code: "demo_attended", name: "Встреча проведена", translationKey: "leadStatusDemoAttended", color: "#a855f7", sortOrder: 50, activePipeline: true },
